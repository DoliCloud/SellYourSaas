...
file_put_contents($pathtospamdir.'/mailquota', "# Content is generated by batch_detect_evil_instances.php from value of instance. If empty, value used is taken from /etc/sellyoursaas-public.conf (param maxemailperday and maxemailperdaypaid).\n", FILE_APPEND);
