...
if (empty($newinstance) || empty($mode)) {
	...
	print "\n";
	print "Usage: ".$script_file." oldinstance.withX.mysaasdomainname.com newinstance.withY.mysaasdomainname.com (test|confirmmaintenance|confirmredirect) [MYPRODUCTREF] [-y]\n";
