...
#/usr/bin/mysqladmin -h localhost processlist > /var/log/repair06_mysqlprocesslist$$.log 2>&1
...
/usr/bin/mysqladmin -h localhost processlist > /var/log/repair09_mysqlprocesslist$$.log 2>&1
