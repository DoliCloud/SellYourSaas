...
/**
 *   	\file       blacklistto_card.php
 *		\ingroup    sellyoursaas
 *		\brief      Page to create/edit/view blacklistto
 */
...
if (empty($reshook)) {
	...
	$backurlforlist = dol_buildpath('/sellyoursaas/blacklistto_list.php', 1);
	...
	if (empty($backtopage) || ($cancel && empty($id))) {
		if (empty($backtopage) || ($cancel && strpos($backtopage, '__ID__'))) {
			if (empty($id) && (($action != 'add' && $action != 'create') || $cancel)) {
				...
				$backtopage = dol_buildpath('/sellyoursaas/blacklistto_card.php', 1).'?id='.((!empty($id) && $id > 0) ? $id : '__ID__');
			}
		}
	}
	...
	$triggersendname = 'SELLYOURSAAS_BLACKLISTTO_SENTBYMAIL';
	$autocopy = 'MAIN_MAIL_AUTOCOPY_BLACKLISTTO_TO';
...
if ($action == 'create') {
	...
	print load_fiche_titre($langs->trans("NewObject", $langs->transnoentitiesnoconv("Blacklistto")), '', 'object_'.$object->picto);
