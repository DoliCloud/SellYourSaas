...
/**
 * \file        class/blacklistto.class.php
 * \ingroup     sellyoursaas
 * \brief       This file is a CRUD class file for Blacklistto (Create/Read/Update/Delete)
 */
...
class Blacklistto extends CommonObject
{
	 ...
	 */
	public $element = 'blacklistto';

	/**
	 * @var string Name of table without prefix where object is stored. This is also the key used for extrafields management.
	 */
	public $table_element = 'sellyoursaas_blacklistto';
	...
	public function getLinesArray()
	{
		...
		$result = $objectline->fetchAll('ASC', 'position', 0, 0, '(fk_blacklistto:=:'.((int) $this->id).')');
