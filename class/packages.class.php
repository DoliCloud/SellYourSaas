...
class Packages extends CommonObject
{
	...
	public $fields=array(
		...
		'cliafterpaid' => array('type'=>'text', 'label'=>'Shell after switch to paying mode (not yet available)', 'visible'=>3, 'enabled'=>1, 'position'=>66, 'notnull'=>-1, 'help'=>"Cli shell executed after entering a payment (or on deployment if customer is already a paying customer)."),
