...
class Packages extends CommonObject
{
	...
	public $fields=array(
		...
		'srcfile1' => array('type'=>'varchar(255)', 'label'=>'Dir with sources 1', 'visible'=>-1, 'enabled'=>1, 'position'=>51, 'notnull'=>-1, 'css'=>'minwidth500', 'csslist'=>'tdoverflowmax400', 'cssview'=>'wordbreak', 'placeholder' => '__DOL_DATA_ROOT__/sellyoursaas/git/myproject'),
		...
		'targetsrcfile1' => array('type'=>'varchar(255)', 'label'=>'Target relative dir for sources 1', 'visible'=>-1, 'enabled'=>1, 'position'=>54, 'notnull'=>-1, 'css'=>'minwidth500', 'csslist'=>'tdoverflowmax400', 'placeholder' => '__INSTANCEDIR__'),
		...
		'datafile1' => array('type'=>'varchar(255)', 'label'=>'Dir with dump files', 'visible'=>-1, 'enabled'=>1, 'position'=>59, 'notnull'=>-1, 'css'=>'minwidth500', 'csslist'=>'tdoverflowmax400', 'placeholder' => '__DOL_DATA_ROOT__/sellyoursaas/packages/__PACKAGEREF__', 'help'=>'You can set here __DOL_DATA_ROOT__/sellyoursaas/packages/__PACKAGEREF__ so you can put the sql dump files from the tab "Linked files"'),
		...
		'cliafterdeployoption' => array('type'=>'text', 'label'=>'Shell after option deployment', 'visible'=>3, 'enabled'=>1, 'position'=>72, 'notnull'=>-1, 'help'=>'Sql executed after an option is deployed from (and only from) the customer dashboard'),
