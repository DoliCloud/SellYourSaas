...
class Packages extends CommonObject
{
	...
	public $fields=array(
		...
		'cliafterpaid' => array('type'=>'text', 'label'=>'Shell after switch to paying mode', 'visible'=>3, 'enabled'=>1, 'position'=>66, 'notnull'=>-1, 'help'=>"Cli shell executed after entering a payment (or on deployment if customer is already a paying customer)."),
		...
		'sqlafterpaid' => array('type'=>'text', 'label'=>'Sql after switch to paid', 'visible'=>3, 'enabled'=>1, 'position'=>72, 'notnull'=>-1, 'help'=>'Sql executed after entering a payment (or on deployment if customer already a paying customer)'),
