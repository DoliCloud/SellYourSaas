...
class Blacklistip extends CommonObject
{
	...
	public $fields=array(
		...
		'date_use' => array('type'=>'datetime', 'label'=>'DateUse', 'enabled'=>'1', 'position'=>500, 'notnull'=>1, 'visible'=>1,),
	...
	public function getLinesArray()
	{
		...
		$result = $objectline->fetchAll('ASC', 'position', 0, 0, array('customsql'=>'fk_blacklistip = '.((int) $this->id)));
