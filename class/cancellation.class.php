...
/**
 * \file        sellyoursaas/class/cancellation.class.php
 * \ingroup     sellyoursaas
 * \brief       This file is a CRUD class file for Cancellation (Create/Read/Update/Delete)
 */
 ...
 */
class Cancellation extends CommonObject
{
	/**
	 * @var string ID to identify managed object
	 */
	public $element = 'cancellation';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'sellyoursaas_cancellation';
	/**
	 * @var array  Does cancellation support multicompany module ? 0=No test on entity, 1=Test with field entity, 2=Test with link by societe
	 */
	public $ismultientitymanaged = 0;
	/**
	 * @var string String with name of icon for cancellation. Must be the part after the 'object_' into object_cancellation.png
	 */
	public $picto = 'cancellation@sellyoursaas';
	...
	public $fields=array(
		...
		'codelang' => array('type'=>'varchar(8)', 'label'=>'Language', 'visible'=>1, 'enabled'=>1, 'position'=>15, 'notnull'=>-1, 'comment'=>"Language",),
		'url' => array('type'=>'varchar(255)', 'label'=>'Url', 'visible'=>1, 'enabled'=>1, 'position'=>35, 'notnull'=>1,),
	);
	public $rowid;
	public $ref;
	public $entity;
