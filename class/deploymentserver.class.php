...
class Deploymentserver extends CommonObject
{
	...
	public $fields=array(
		...
		'serversignaturekey' => array('type'=>'varchar(128)', 'label'=>'ServerSignatureKey', 'enabled'=>'1', 'position'=>170, 'notnull'=>0, 'visible'=>5),
	...
	public function getTooltipContentArray($params)
	{
		...
		$datas['picto'] = img_picto('', $this->picto).' <u>'.$langs->trans("Deploymentserver").'</u>';
	...
	public function getKanbanView($option = '', $arraydata = null)
	{
		...
		if ($this->nb_backuptotal) {
			...
			$return .= $this->nb_backupok.'/'.$this->nb_backuptotal;
			if ($this->nb_backuptotal != $this->nb_backupok) {
				$return .= '</span>';
			}
		}
	...
	public function LibStatut($status, $mode = 0)
	{
		...
		if (empty($this->labelStatus) || empty($this->labelStatusShort)) {
			...
			$this->labelStatus[self::STATUS_ENABLED] = $langs->transnoentitiesnoconv('Opened');
			$this->labelStatus[self::STATUS_DISABLED] = $langs->transnoentitiesnoconv('Closed');
			$this->labelStatusShort[self::STATUS_ENABLED] = $langs->transnoentitiesnoconv('Opened');
			$this->labelStatusShort[self::STATUS_DISABLED] = $langs->transnoentitiesnoconv('Closed');
		}
