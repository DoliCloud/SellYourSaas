...
/**
 *   	\file       blacklistip_list.php
 *		\ingroup    sellyoursaas
 *		\brief      List page for blacklistip
 */
...
require_once __DIR__.'/class/blacklistip.class.php';
...
$hookmanager->initHooks(array('blacklistiplist')); // Note that conf->hooks_modules contains array
...
if (empty($reshook)) {
	...
	// Mass actions
	$objectclass = 'Blacklistip';
	$objectlabel = 'Blacklistip';
...
if ($num == 1 && !empty($conf->global->MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE) && $search_all && !$page) {
	...
	$id = $obj->rowid;
	header("Location: ".dol_buildpath('/sellyoursaas/blacklistip_card.php', 1).'?id='.$id);
	exit;
}
