...
/**
 *  \file       htdocs/sellyoursaas/template/myobject_agenda.php
 *  \ingroup    sellyoursaas
 *  \brief      Tab of events on deploymentserver
 */
...
if ($object->id > 0) {
	$title = $langs->trans("deploymentserver")." - ".$langs->trans('Agenda');
	//$title = $object->ref." - ".$langs->trans("Agenda");
	$help_url = 'EN:Module_Agenda_En|DE:Modul_Terminplanung';

	llxHeader('', $title, $help_url, '', 0, 0, '', '', '', 'mod-sellyoursaas page-card_agenda');
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("deploymentserver"), -1, $object->picto);
