...
--ALTER TABLE llx_sellyoursaas_deploymentserver ADD CONSTRAINT llx_sellyoursaas_deploymentserver_fk_field FOREIGN KEY (fk_field) REFERENCES llx_sellyoursaas_myotherobject(rowid);
