...
This project contains the sources of external module SellYourSaas. It contains doc, shell scripts and a module designed for the Dolibarr ERP and CRM application.
