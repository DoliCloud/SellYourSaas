...
class modSellYourSaas extends DolibarrModules
{
	...
	public function init($options = '')
	{
		...
		$resultx=$extrafields->addExtraField('source_choice', 'SourceChoice', 'chkbxlst', 104, '', 'thirdparty', 0, 0, '', array('options' => array('c_sellyoursaas_source_choice:label:code' => null)), 1, 'isModEnabled("sellyoursaas")', 1, '', '', '', 'sellyoursaas@sellyoursaas', 'isModEnabled("sellyoursaas")');
