...
class modSellYourSaas extends DolibarrModules
{
	...
	function init($options='')
	{
		...
		$param=array('options'=>array('0'=>'SystemDefault','1'=>'CommonUserJail','2'=>'PrivateUserJail'));
		$resultx=$extrafields->addExtraField('sshaccesstype', 	                    "SshAccessType",   'select', 122,    '',    'contrat', 0, 0,    '',  $param, 1, '', '($conf->global->SELLYOURSAAS_SSH_JAIL_ENABLED?1:0)', 'HelpOnSshAccessType', '', '', 'sellyoursaas@sellyoursaas', '$conf->sellyoursaas->enabled');
