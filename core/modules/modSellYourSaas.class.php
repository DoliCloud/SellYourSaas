...
class modSellYourSaas extends DolibarrModules
{
	...
	function init($options='')
	{
		...
		$resultx=$extrafields->addExtraField('deployment_tor_proba',         "DeploymentIPTORProba",   'double', 107, '8,4',    'contrat', 0, 0,    '',      '', 1, '', -1, 'DeploymentIPTORProbaDesc:iptorprob', '', '', 'sellyoursaas@sellyoursaas', '$conf->sellyoursaas->enabled');
