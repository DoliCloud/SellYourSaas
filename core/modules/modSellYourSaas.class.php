...
class modSellYourSaas extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->module_parts = array('triggers' => 1,
									...
									'login' => 1,
									'css' => array(),
									'hooks' => array('globalcard','thirdpartycard','thirdpartycomm','suppliercard','thirdpartycontact','contactthirdparty','thirdpartyticket','thirdpartynote','thirdpartydocument','thirdpartypartnership',
	...
	public function init($options = '')
	{
		...
		$resultx=$extrafields->addExtraField('reasonundeployother',                      "ReasonUninstallOther", 'text',    300, '8192',   'contrat', 0, 0,  '',      '', 1, '', -1, 0, '', '', 'sellyoursaas@sellyoursaas', '$conf->sellyoursaas->enabled');
