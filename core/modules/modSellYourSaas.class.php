...
class modSellYourSaas extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->cronjobs = array(
			...
			3 =>array('priority'=>74, 'label'=>'SellYourSaasTakePaymentNonProfitOrganization',  'jobtype'=>'method', 'class'=>'/sellyoursaas/class/sellyoursaasutils.class.php', 'objectname'=>'SellYourSaasUtils', 'method'=>'	doTakePaymentNonProfitOrganization', 'parameters'=>'0, 0',  'comment'=>'Loop on invoice for customer which are non profit organizations. Unsuspend if it was suspended and all payments are now ok (done by trigger BILL_CANCEL or BILL_PAYED). First parameter is the maximum number of payments processed in one run. Second parameter is 1 to disable email to customer if payment fails.', 'frequency'=>1, 'unitfrequency'=>86400, 'status'=>$statusatinstall, 'test'=>'$conf->sellyoursaas->enabled && $conf->global->SELLYOURSAAS_ENABLE_FREE_PAYMENT_MODE', 'datestart'=>$datestart),
