...
class modSellYourSaas extends DolibarrModules
{
	...
	function init($options='')
	{
		...
		$resultx=$extrafields->addExtraField('username_ro_db',              "Read-only Username DB",  'varchar', 128,  '32',    'contrat', 1, 0,    '',      '', 1, '', -1, 'ToUpdateDBPassword', '', '', 'sellyoursaas@sellyoursaas', '$conf->sellyoursaas->enabled');
