...
class modSellYourSaas extends DolibarrModules
{
	...
	function init($options='')
	{
		...
		$resultx=$extrafields->addExtraField('position', 	                       "Position",  'varchar',  120,    '5',  'product', 0, 0,   '',     '', 1, '',  1, 0, '', '', 'sellyoursaas@sellyoursaas', '$conf->sellyoursaas->enabled');
		...
		$resultx=$extrafields->addExtraField('optincommercialmessage', "OptinForCommercialMessages",  'boolean',193,   '',  'thirdparty', 0, 0, '',     '', 1, '', -1, 0, '', '', 'sellyoursaas@sellyoursaas', '$conf->sellyoursaas->enabled');
