...
$help_url='';
$title = $langs->trans('ListOfCancellationForms');
$morejs = array();
$morecss = array();
...
$newcardbutton = dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', dol_buildpath('/sellyoursaas/cancellation_card.php', 1).'?action=create&backtopage='.urlencode($_SERVER['PHP_SELF']), '', $permissiontoadd);
...
while ($i < ($limit ? min($num, $limit) : $num)) {
	...
	// Fields from hook
	$parameters=array('arrayfields'=>$arrayfields, 'object'=>$object, 'obj'=>$obj);
