...
$contextpage = GETPOST('contextpage', 'aZnone') ? GETPOST('contextpage', 'aZ') : str_replace('_', '', basename(dirname(__FILE__)).basename(__FILE__, '.php')); // To manage different context of search
...
$hookmanager->initHooks(array('deploymentserverlist')); // Note that conf->hooks_modules contains array
...
if ($enablepermissioncheck) {
	...
	$permissiontodelete = $user->rights->sellyoursaas->deploymentserver->delete;
} else {
	$permissiontoread = 1;
	$permissiontoadd = 1;
