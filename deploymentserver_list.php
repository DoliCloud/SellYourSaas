...
while ($i < $imaxinloop) {
	...
	if ($mode == 'kanban') {
		...
		if (!empty($arrayfields['commands']['checked'])) {
			...
			$html = '<span class="small">'.$langs->trans("CommandForDeploymentServer").':</span><br>';
			$html .= '<br>';
			...
			$html .= '<div class="urllink"><input type="text" class="quatrevingtpercent" spellcheck="false" value="';
			$html .= getDolGlobalString('DOLICLOUD_SCRIPTS_PATH').'/deployment_deploy_module.php test|confirm PRODUCTREF afilter*.'.$object->ref.' withX.mysaaasdomain.com allow [FR]';
			$html .= '">';
			$html .= '</div>';
