...
/**
 *   	\file       blacklistcontent_list.php
 *		\ingroup    sellyoursaas
 *		\brief      List page for blacklistcontent
 */
...
require_once __DIR__.'/class/blacklistcontent.class.php';
...
$hookmanager->initHooks(array('blacklistcontentlist')); // Note that conf->hooks_modules contains array
...
if ($enablepermissioncheck) {
	...
	$permissiontoadd = $user->rights->sellyoursaas->blacklistmail->write;
	$permissiontodelete = $user->rights->sellyoursaas->blacklistmail->delete;
} else {
	$permissiontoread = 1;
	$permissiontoadd = 1;
...
if (empty($reshook)) {
	...
	// Mass actions
	$objectclass = 'Blacklistcontent';
	$objectlabel = 'Blacklistcontent';
...
//$help_url = "EN:Module_Blacklistmail|FR:Module_Blacklistmail_FR|ES:Módulo_Blacklistmail";
$help_url = '';
...
if ($num == 1 && getDolGlobalInt('MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE') && $search_all && !$page) {
	...
	$id = $obj->rowid;
	header("Location: ".dol_buildpath('/sellyoursaas/blacklistcontent_card.php', 1).'?id='.$id);
	exit;
}
...
$newcardbutton .= dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', dol_buildpath('/sellyoursaas/blacklistcontent_card.php', 1).'?action=create&backtopage='.urlencode($_SERVER['PHP_SELF']), '', $permissiontoadd);

print_barre_liste($title, $page, $_SERVER["PHP_SELF"], $param, $sortfield, $sortorder, $massactionbutton, $num, $nbtotalofrecords, 'object_'.$object->picto, 0, $newcardbutton, '', $limit, 0, 0, 1);

print '<span class="opacitymedium">'.$langs->trans("BlacklistcontentDesc").'</span><br><br>';

// Add code for pre mass action (confirmation or email presend form)
$topicmail = "SendBlacklistmailRef";
$modelmail = "blacklistcontent";
$objecttmp = new Blacklistcontent($db);
