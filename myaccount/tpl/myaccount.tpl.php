				...
				<input type="hidden" name="mode" value="'.dol_escape_htmltag($mode).'">
	              ...
	              <div class="form-body">
	                <div class="form-group">
	                  ...
	                  <input type="password" class="form-control" name="password" minlength="8" maxlength="128" autocomplete="new-password" spellcheck="false" autocapitalize="off">
	                </div>
	                <div class="form-group">
	                  <label>'.$langs->trans("RepeatPassword").'</label>
	                  <input type="password" class="form-control" name="password2" minlength="8" maxlength="128" autocomplete="new-password" spellcheck="false" autocapitalize="off">
	                </div>
	              </div>
	              <div class="center">
