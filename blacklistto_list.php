...
/**
 *   	\file       blacklistto_list.php
 *		\ingroup    sellyoursaas
 *		\brief      List page for blacklistto
 */
...
require_once __DIR__.'/class/blacklistto.class.php';
...
$hookmanager->initHooks(array('blacklisttolist')); // Note that conf->hooks_modules contains array
...
if (empty($reshook)) {
	...
	// Mass actions
	$objectclass = 'Blacklistto';
	$objectlabel = 'Blacklistto';
...
if ($num == 1 && !empty($conf->global->MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE) && $search_all && !$page) {
	...
	$id = $obj->rowid;
	header("Location: ".dol_buildpath('/sellyoursaas/blacklistto_card.php', 1).'?id='.$id);
	exit;
}
...
$newcardbutton .= dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', dol_buildpath('/sellyoursaas/blacklistto_card.php', 1).'?action=create&backtopage='.urlencode($_SERVER['PHP_SELF']), '', $permissiontoadd);

print_barre_liste($title, $page, $_SERVER["PHP_SELF"], $param, $sortfield, $sortorder, $massactionbutton, $num, $nbtotalofrecords, 'object_'.$object->picto, 0, $newcardbutton, '', $limit, 0, 0, 1);

print '<span class="opacitymedium">'.$langs->trans("BlacklistXDesc", "to").'</span><br><br>';

// Add code for pre mass action (confirmation or email presend form)
$topicmail = "SendBlacklistmailRef";
$modelmail = "blacklistto";
$objecttmp = new Blacklistto($db);
