...
/bin/secureBash {
  ...
  /usr/share/vim/vim72/lang/en_GB/LC_Mvi /etc/ImageMagick-6/policy.xmlESSAGES/vim.mo r,
...
* To avoid to have apparmor relaunched after a manual stop, modify */lib/systemd/system/apparmor.service* to set *RemainAfterExit=no*
