...
Try to read the max_execution_time of your database with:  show variables like '%max_execution_time%';

Then try to increase it with:  SET global max_execution_time = ...;    with millisecond 
