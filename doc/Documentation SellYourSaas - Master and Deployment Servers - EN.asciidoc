...
Note: If you need to recover data files from another disk, use:
...
* If the backup of all Webmin bases is active, modify the files */usr/share/webmin/mysql/backup.pl* and  */usr/share/webmin/mysql/backup_db.cgi*
