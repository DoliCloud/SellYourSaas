...
allowed_hosts=ipofmasterserver
...
Note: *securitykeydefinedinscheduledjobsetup* is the value of the key to decide. And *batch* is the user dedicated for batch processing. You will set them
...
The comment will be saved into an extrafield in the template invoice and will be shown on the generated invoice. 
