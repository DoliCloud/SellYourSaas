...
---------------
sudo apt update
sudo apt install -y ntp git gzip zip zstd memcached ncdu acl ufw sudo
...
---------------
sudo apt update
sudo apt install -y systemd-timesyncd git gzip zip zstd memcached ncdu acl ufw sudo
sudo apt install -y mariadb-server mariadb-client
sudo apt install -y apache2 apache2-bin lynx
