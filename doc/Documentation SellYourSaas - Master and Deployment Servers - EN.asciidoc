...
As well as the specific rules for sellyoursaas:
  ...
  *web-accesslog-limit401*, *web-accesslog-limit403*,
...
999GB    (Don't input the default value but the max value of disk size found on line "Disk...:" that was shown by "print all free")
q
---------------
...
=== Restoring a root access or a server blocked by a firewall
