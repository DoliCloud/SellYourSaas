...
REPLACE INTO llx_const (name, entity, value, type, visible) values ('MAIN_EXTERNAL_SMTP_CLIENT_IP_ADDRESS', 0, '<deployment-server-1.ip>[, deployment-server-23.ip, \[deployment-server-1-IPv^-between-actual-brackets\]]', 'chaine', 0);
