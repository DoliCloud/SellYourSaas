...
<VirtualHost *:80>
        ...
        AuthUserFile /home/admin/wwwroot/dolibarr/htdocs/.htpasswd
        require valid-user
        </Directory>
...
Create the file */home/admin/wwwroot/dolibarr/htdocs/.htpasswd* with 
[source, bash]
---------------
htpasswd -cm /home/admin/wwwroot/dolibarr/htdocs/.htpasswd <wanted username>
---------------
