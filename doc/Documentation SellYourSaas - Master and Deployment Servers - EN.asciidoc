...
<VirtualHost *:80>
        ...
        <Files ~ "(document\.php|viewimage\.php|\.js\.php|\.js|\.css\.php|\.css|\.gif|\.svg|\.woff2|favicon\.ico)$">
        AuthType None
        Require all granted
        Satisfy any
        </Files>
...
* On the *deployment servers*, to create automatically renewable wildcard certificates :
