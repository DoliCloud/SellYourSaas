...
After this addition, a new field *"SSH access type"* is now available in the service of the Application to deploy:
...
Just set this field on the service of the Application to deploy to value *JailKit* and new contracts will be deployed using an account in jailkit.
