...
# Set to 1 if this server is the master server, 2 if the ssh and mysql access are restricted to ips into /etc/sellyoursaas-allowed-ip.d/sellyoursaas-allowed-ip.conf only
masterserver=1
# Set to 1 if this server host instances for the pool (deployment server), 2 if the ssh and mysql access are restricted to ips into /etc/sellyoursaas-allowed-ip.d/sellyoursaas-allowed-ip.conf only
instanceserver=1
