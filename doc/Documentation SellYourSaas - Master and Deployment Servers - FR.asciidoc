...
=== Configuration du serveur DNS Bind sur les serveurs Master
...
=== Configuration du serveur DNS Bind sur les serveurs de Déploiement
...
Mettre à jour le DNS du nom de domaine principal *mysaasdomainname.com* pour ajouter un enregistrement *A* pour 
    ...
    *ns2with2.mysaasdomainname.com*       Serveur DNS 2 des instances utilisateurs pointant sur l'ip du serveur de Déploiement
