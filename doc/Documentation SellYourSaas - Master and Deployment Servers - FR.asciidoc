...
- Ajouter les entrées du nouveau serveur dans le DNS mysellyoursaasdomainname.com avec l'IP du serveur attribué par OVH lors de sa création.
...
- Aller dans l'interface de gestion des IP OVH, pour ajouter aussi 
  ...
  - le reverse sur l'IP du nouveau serveur: monserveur.mysellyoursaasdomainname.com
