...
Sur les serveurs de déploiement, copier la clé publique et privé du compte ssh *admin* du masteur en /home/admin/.ssh/id_rsa_sellyoursaas... (Cette clé est celle commune pour la maintenance pour accéder aux comptes utilisateurs).
