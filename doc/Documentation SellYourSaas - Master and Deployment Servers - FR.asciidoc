...
* Récupérer les certificats SSL (fichier .crt de certificat et de certificat intermédiaire) et les installer dans le chemin des certificats SSL spécifiés par le modèle de virtual host pour les instances (les modèles de virtual hosts sont dans sellyoursaas/scripts/templates/)
