...
databasepass=...
# Set this to 1 if you use Mysql or MariaDB > 10.4 (for "SET PASSWORD" method)
...
To check customer ip in register page when server is behind proxy
* SELLYOURSAAS_SERVER_REMOTE_ADDR_VARNAME = HTTP_X_FORWARDED_FOR
