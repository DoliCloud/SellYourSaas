...
0 18 * * 1 find /mnt/diskbackup/*/ -type d -empty -ls -delete > /var/log/find_delete_empty_dir.log 2>&1
---------------
...
=== Use of btrfs to create a subvolume vor each backup dir of each server
...
[source,bash]
---------------
btrfs subvolume snapshot -r /mnt/diskbackup/xxx /mnt/diskbackup/.snapshots/xxx
---------------
...
[source,bash]
---------------
btrfs subvolume delete /mnt/diskbackup/.snapshots/xxx
---------------
