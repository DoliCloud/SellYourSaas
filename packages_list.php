...
//restrictedArea($user, $object->module, $object->id, $object->table_element, '', 'fk_soc', 'rowid', $isdraft);
...
if ($num == 1 && getDolGlobalInt('MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE') && $search_all && !$page) {
	...
	$id = $obj->rowid;
	header("Location: ".dol_buildpath('/sellyoursaas/packages_card.php', 1).'?id='.((int) $id));
	exit;
}
...
$newcardbutton .= dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', dol_buildpath('/sellyoursaas/packages_card.php', 1).'?action=create&backtopage='.urlencode($_SERVER['PHP_SELF']), '', $permissiontoadd);
...
if ($search_all) {
	...
	print '<!-- Search done like if PACKAGE_QUICKSEARCH_ON_FIELDS = '.$setupstring.' -->'."\n";
